...
if ( ! class_exists( 'Ivole_QTranslate' ) ) :

	class Ivole_QTranslate {
	  public function __construct() {
		...
		public function translate_admin( $page_configs ) {
			//tab = Review Reminder
			$page_config = array();
			$page_config['pages'] = array( 'admin.php' => 'page=wc-settings&tab=ivole(&section=|&section|)$');
			...
			$page_config = array();
			$page_config['pages'] = array( 'admin.php' => 'page=wc-settings&tab=ivole&section=ivole_coupons');
