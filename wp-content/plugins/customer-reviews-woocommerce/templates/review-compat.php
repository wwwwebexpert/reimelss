...
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container cust-review dfg">
		<div class="a-row a-spacing-mini">
			<a href="" class="a-profile">
				...
				<div class="a-profile-content">
					<span class="a-profile-name"><?php comment_author(); ?></span>
				</div>
			</a>
		</div>
		...
		<div class="rating-line">
			<p class="rating">
				...
				<?php endif; ?>
			<span>Awesome Buy!</span></p>
			<p class="red-text">Verified Customer</p>
			<p class="customer-remark">
				<?php do_action( 'ivole_woocommerce_review_before_comment_text', $comment ); ?>

				<div itemprop="description" class="description"><?php comment_text(); ?></div>

				<?php do_action( 'ivole_woocommerce_review_after_comment_text', $comment ); ?>
			</p>
