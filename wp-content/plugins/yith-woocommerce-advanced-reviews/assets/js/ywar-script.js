...
jQuery(document).ready(function ($) {
     ...
     */
    $(ywar.tab_selector).on('click', 'a.ywar_filter_reviews', function (e) {
        e.preventDefault();
        cancel_reply();
    ...
    $(ywar.tab_selector).on('click', 'a.ywar_filter_order', function (e) {
        e.preventDefault();
        cancel_reply();
    ...
    $(ywar.tab_selector).on('click', 'a.edit-my-reviews', function (e) {
        e.preventDefault();
    ...
    $(ywar.tab_selector).on('click', 'a.comment-reply-link', function (e) {
