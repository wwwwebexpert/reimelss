...
class YWAR_Review_Report extends WC_Admin_Report
{
    ...
    public function output_report()
    {
        ...
        $ranges = array(
            'year' => __('Year', 'yith-woocommerce-advanced-reviews'),
            'last_month' => __('Last Month', 'yith-woocommerce-advanced-reviews'),
            'month' => __('This Month', 'yith-woocommerce-advanced-reviews'),
        );
