			...
			<div class="row">
				<div class="col-sm-6">
					<ul class="top-header-nav pull-left">
						...
						<li><a href="{!! get_page_link(28) !!}"><i class="fas fa-user"></i> My Account</a></li>
						<li><i class="fas fa-heart"></i>{!! do_shortcode('[ti_wishlist_products_counter]') !!}</li>
						<li class="logoutbtn"><a href="{!! wp_logout_url( home_url() ) !!}"><i class="fas fa-sign-in-alt"></i> Logout</a></li>
						@else
	  		...
	  		<div class="header-top"><!--header-top-->
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<div class="logo">
								<h2 class="header-logo"><a href="{!! site_url(); !!}">{!! the_field('logo_text','option'); !!}</a></h2>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="logo-right pull-right">
								<ul class="">
									<li class="dropdown">
									  	<a href="#" class="dropdown-toggle cart" data-toggle="dropdown" role="button" aria-expanded="false"> <i class="fas fa-shopping-bag"></i> {!! sprintf ( _n( '%d item', '%d item(s)', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ) !!}<span class="caret"></span></a>
									...
									<li class="search-bar">
										<form id="custom-search-form" class="form-search form-horizontal" action="{!! site_url() !!}" method="get">
							 	...
							 	<ul>
							  		<li><i class="fas fa-globe"></i> EN <i class="fa fa-angle-down" aria-hidden="true"></i>
										<ul>
									   		...
									   		<li><span>{!! do_shortcode('[glt language="German" label="German" image="yes" text="yes" image_size="15"]') !!}</span></li>
