    ...
    <section class="single-product-sec">
		<div class="container">
				...
				<div class="col-sm-4">
					<div class="product-slider">
						<div class="preview-pic tab-content">
							<div class="tab-pane active" id="pic-1"><img src="{!! $src[0] !!}" /></div>
							@foreach( $attachment_ids as $attachment_id ) 
						        @php ( $Original_image_url = wp_get_attachment_url( $attachment_id ) )
						        <div class="tab-pane" id="pic-{{ $loop->iteration + '1' }}"><img src="{!! wp_get_attachment_url($attachment_id, 'full') !!}" /></div>
						    @endforeach
							
							<!-- <div class="tab-pane" id="pic-3"><img src="@asset('images/product1-img3.jpg')" /></div>
							<div class="tab-pane" id="pic-4"><img src="@asset('images/product1-img4.jpg')" /></div> -->
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
							<li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="{!! $src[0] !!}" /></a></li>
							@foreach( $attachment_ids as $attachment_id ) 
						        @php ( $Original_image_url = wp_get_attachment_url( $attachment_id ) )
						        <li><a data-target="#pic-{!! $loop->iteration + '1' !!}" data-toggle="tab"><img src="{!! wp_get_attachment_url($attachment_id, 'full') !!}" /></a></li>
						    @endforeach
							<!-- <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="@asset('images/product1-img.jpg')" /></a></li>
							<li><a data-target="#pic-2" data-toggle="tab"><img src="@asset('images/product1-img2.jpg')" /></a></li>
							<li><a data-target="#pic-3" data-toggle="tab"><img src="@asset('images/product1-img3.jpg')" /></a></li>
							<li><a data-target="#pic-4" data-toggle="tab"><img src="@asset('images/product1-img4.jpg')" /></a></li> -->
						</ul>		
					</div>
				</div>
				<div class="col-sm-5">
					<div class="product-detail">
						...
						<ul class="customer-review-rating">
							<li>{!! $productstarrating['0']->p_star !!}</li>
							<li><span><a href="">{!! $productstarrating['0']->p_count !!} customer reviews</a></span><!--  | <span><a href="">50 answered question</a></span> --></li>
						</ul>
						<hr>
        						...
        						<tbody>
        							...
        							<tr id="priceblock_dealprice_row">
										...
										<td class="right-size-base">
    									   <span id="priceblock_dealprice" class="a-color-price">{!! $p_currency.$singleproductdata['0']->p_price !!}</span>
            							</td>
									</tr>
        							@else
        							<tr>
										...
										<td class="right-size-base">
											<span class="a-text-strike">{!! $p_currency.$singleproductdata['0']->p_price !!}</span>
    									</td>
									</tr>
                					<tr id="priceblock_dealprice_row">
										<td id="priceblock_dealprice_lbl" class="a-text-right">Deal of the Day:</td>
										<td class="right-size-base">
    									   <span id="priceblock_dealprice" class="a-color-price">{!! $p_currency.$singleproductdata['0']->p_sale !!}</span>
            							</td>
									</tr>
									<tr id="dealprice_savings">
										<td class="a-text-right">You Save:</td>
										<td class="right-size-base red-text">{!! $p_currency.$singleproductdata['0']->p_discount !!} ({!! $singleproductdata['0']->p_discount_per !!}%)</td>
									</tr>
        							@endif
								</tbody>
							</table>
						...
						<div class="sale-details">
							<ul class="stock-details">
								<li>
									<h3>{!! $addtocartform['0']->p_stockstatus !!}</h3>
									<div class="progress">
							...
							<p class="a-dropdown-container">
								...
								<select name="quantity" autocomplete="off" id="quantity" tabindex="-1" class="a-native-dropdown">
									@for ($i = 1; $i <= $p_quantity; $i++)
	                    				<option data-id="{{ $productId }}" value="{{ $i }}">{{ $i }}</option>
									@endfor
	                            </select>
							</p>
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
				  ...
				  <div class="carousel carousel-showmanymoveone slide" id="itemslider">
					<div class="carousel-inner">
						@php ( $count = '1' )
						@foreach ($relatedProducts as $r_p_data)
							@if ($count%6 == 1)  
						        <div class="item @if ($loop->iteration == 1) {{ 'active' }} @endif">
						    @endif
								<div class="item @if ($loop->iteration == 1) {{ 'active' }} @endif">
									<div class="col-xs-12 col-sm-6 col-md-2">
									  <a href="{{ $r_p_data->p_link }}">
										<img src="{{ $r_p_data->p_img }}" class="img-responsive center-block">
										<p class="product-name">{{ $r_p_data->p_title }}</p>
										<!-- <img src="@asset('images/4-star.png')" alt="" class="img-responsive"> -->
										<p class="price">{!! $r_p_data->p_price !!}</p>
									  </a>
									</div>
								</div>
							@if ($count%6 == 0)
					...
					<a class="left carousel-control" href="#itemslider" data-slide="prev"><img src="@asset('images/left-arrow.png')" alt="Left" class="img-responsive"></a>
					<a class="right carousel-control" href="#itemslider" data-slide="next"><img src="@asset('images/right-arrow.png')" alt="Right" class="img-responsive"></a>
				  </div>
				  </div>
			...
			<div class="customer-reviews">
				<p>{!! $productstarrating['0']->p_star !!} <span class="tolal-sale">{!! $productstarrating['0']->p_count !!}</span></p>

				<!-- <p><img src="@asset('images/4str.png')" alt="" class="img-responsive star-rating"> <span class="tolal-sale">23,414</span></p> -->

				<div class="tooltip-col product-rating">{!! $productstarrating['0']->p_average !!} out of 5 stars <i class="fas fa-caret-down"></i>
				...
				<div class="top-reviews">
					...
					<!-- <div class="cust-review">
						<div class="a-row a-spacing-mini">
							<a href="" class="a-profile">
								<div aria-hidden="true" class="a-profile-avatar-wrapper">
									<div class="a-profile-avatar"><img src="@asset('images/customer.png')" class=""></div>
								</div>
						...
						<div class="rating-line">
							<p class="rating"><img src="@asset('images/5-star.png')" alt="" class="img-responsive"> <span>Awesome Buy!</span></p>
					...
					<!--<div class="cust-review">
						<div class="a-row a-spacing-mini">
							<a href="" class="a-profile">
								<div aria-hidden="true" class="a-profile-avatar-wrapper">
									<div class="a-profile-avatar"><img src="@asset('images/customer1.png')" class=""></div>
								</div>
								<div class="a-profile-content">
						...
						<div class="clearfix"></div>
						<div class="rating-line">
							<p class="rating"><img src="@asset('images/5-star.png')" alt="" class="img-responsive"> <span>Best Price</span></p>
							<p class="red-text">Verified Customer</p>
							<p class="customer-remark">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu.</p>
						</div>
