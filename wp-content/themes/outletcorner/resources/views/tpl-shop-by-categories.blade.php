{{--
  Template Name: Shop By Categories
--}}
					...
					<div class="col-xs-12 col-sm-12 col-md-12">
					  <div class="carousel carousel-showmanymoveone slide" id="itemslider">
						<div class="carousel-inner">
							@php ( $count = '1' )
							@foreach ($productcategories as $index => $f_c_data)
								@if ($count%4 == 1)  
							        <div class="item @if ($loop->iteration == 1) {{ 'active' }} @endif">
							    @endif
									<div class="col-xs-12 col-sm-6 col-md-2">
									  <a href="{{ $f_c_data->p_cat_link }}"><img src="{{ $f_c_data->p_cat_img }}" class="img-responsive center-block"></a>
						  ...
						  <!-- <div class="item active">
							<div class="col-xs-12 col-sm-6 col-md-2">
							  <a href="#"><img src="@asset('images/books.png')" class="img-responsive center-block"></a>
							  <h4 class="text-center">Books</h4>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-2">
							  <a href="#"><img src="@asset('images/books.png')" class="img-responsive center-block"></a>
						  ...
						  <div class="item">
							<div class="col-xs-12 col-sm-6 col-md-2">
							  <a href="#"><img src="@asset('images/CABEL.png')" class="img-responsive center-block"></a>
							...
							<div class="row">
								<div class="category-box">
									<div class="col-sm-3 pad-7">
										<div class="category-img-sec">
											<div class="category-img">
												<img src="@asset('images/curtain.jpg')" alt="" class="img-responsive">
									...
									<div class="col-sm-6 pad-7">
										<div class="category-img-sec">
											<div class="category-img">
												<img src="@asset('images/books.jpg')" alt="" class="img-responsive">
												<h3><a href="">Category Name</a></h3>
											</div>
										</div>
									</div>
									<div class="col-sm-3 pad-7">
										<div class="category-img-sec">
											<div class="category-img">
												<img src="@asset('images/cosmetic.jpg')" alt="" class="img-responsive">
												<h3><a href="">Category Name</a></h3>
											</div>
										</div>
									</div>
								...
								<div class="category-box2">
									<div class="col-sm-4 pad-7">
										<div class="category-img-sec">
											<div class="category-img">
												<img src="@asset('images/bag.jpg')" alt="" class="img-responsive">
												<h3><a href="">Category Name</a></h3>
											</div>
										</div>
									</div>
									<div class="col-sm-4 pad-7">
										<div class="category-img-sec">
											<div class="category-img">
												<img src="@asset('images/grocery.jpg')" alt="" class="img-responsive">
												<h3><a href="">Category Name</a></h3>
											</div>
										</div>
									</div>
									<div class="col-sm-4 pad-7">
										<div class="category-img-sec">
											<div class="category-img">
												<img src="@asset('images/mobile.jpg')" alt="" class="img-responsive">
												<h3><a href="">Category Name</a></h3>
											</div>
										</div>
									</div>
										...
										<div class="carousel-inner">
										  <div class="item active">
											<div class="col-xs-12 col-sm-6 col-md-3">
												<a href="#">
													<img src="@asset('images/img1.png')" class="img-responsive center-block">
										  ...
										  <div class="item">
											 <div class="col-xs-12 col-sm-6 col-md-3">
												<a href="#">
													<img src="@asset('images/img2.png')" class="img-responsive center-block">
									  ...
									  <div class="carousel carousel-showmanymove slide" id="carouselABC">
										<div class="carousel-inner">
										  <div class="item active">
											<div class="col-xs-12 col-sm-6 col-md-3">
												<a href="#">
													<img src="@asset('images/img3.png')" class="img-responsive center-block">
													<p class="product-name">ACDelco PF2257G Professional Engine Oil Filter and O-Ring</p>
													<img src="@asset('images/5-star.png')" alt="" class="img-responsive">
													<p class="price">$15.79</p>
												</a>
											</div>
											<div class="col-xs-12 col-sm-6 col-md-3">
										  ...
										  <div class="item">
											 <div class="col-xs-12 col-sm-6 col-md-3">
												<a href="#">
													<img src="@asset('images/img6.png')" class="img-responsive center-block">
									  ...
									  <div class="carousel carousel-showmanymove slide" id="carouselXYZ">
										<div class="carousel-inner">
										  <div class="item active">
											<div class="col-xs-12 col-sm-6 col-md-3">
												<a href="#">
													<img src="@asset('images/img9.png')" class="img-responsive center-block">
										  ...
										  <div class="item">
											 <div class="col-xs-12 col-sm-6 col-md-3">
												<a href="#">
													<img src="@asset('images/img10.png')" class="img-responsive center-block">
